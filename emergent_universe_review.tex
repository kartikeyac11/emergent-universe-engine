...
\end{tikzpicture}
\caption{Data-flow diagram of the eight engines that run sequentially
  each simulation step, from the physics substrate at the top to the
  in-universe science engine at the bottom.}
\label{fig:arch}
\end{figure}
